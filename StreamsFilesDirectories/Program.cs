    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //FileStream stream = new FileStream("../../../input.txt", FileMode.)
             //сега за да мога да пише по този файл трябва да използвам някакъв буфер, понеже стриймовете използват поредижа от байтове, трябва да използвам байт масив който да ми е буфер и с него да чета и пиша в/у този файл използвайки стийма който съм създал!
        }
    }
}
